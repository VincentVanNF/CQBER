...
class BaseOptions(object):
    ...
    def initialize(self):
        ...
        self.parser.add_argument("--dset_name", type=str, choices=["tvr","acn"])
        ...
        self.parser.add_argument("--query_image_patches", type=int, default=49,
                                help="clip vit model image into patches feature, 49 for 7x7")
        self.parser.add_argument("--query_image_size", type=int, default=768,
                                help="clip vit model hidden size, 768")
        ...
        self.parser.add_argument("--query_image_patches_path", type=str, default=None)
        ...
        self.parser.add_argument("--no_norm_query_image_feat", action="store_true", help="Do not do normalization on query image feat")
